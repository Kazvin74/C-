...
int main() {
    ...
    while (Number > 1) {
        ...
        if (Remainder == 1) Number = 3 * Number + 1;
        else if (Remainder == 0) Number = Number / 2;
        if (IncludeSequenceNumber == "N") cout << Number << endl;
        else if (IncludeSequenceNumber == "Y") cout << SequenceNumber << ". " << Number << endl;
        SequenceNumber++;
    }
