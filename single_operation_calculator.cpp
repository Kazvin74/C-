...
int main () {
    ...
    while (1) {
        ...
        cout << "Operator (+, -, *, /, %, ^, R): ";
        cin >> Operator;
        if (Operator == "+") answer = first_number + second_number;
        else if (Operator == "-") answer = first_number - second_number;
        else if (Operator == "*") answer = first_number * second_number;
        else if (Operator == "/") answer = first_number / second_number;
        else if (Operator == "%") {
        ...
        else if (Operator == "^") answer = pow(first_number, second_number);
        else if (Operator == "R") answer = pow(first_number, 1/second_number);
