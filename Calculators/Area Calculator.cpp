...
int main() {
    ...
    cout << "Shape (ex. SC): "; cin >> Shape;
    cout << "Decimal Places: "; cin >> DecimalPlaces; cout << endl;
    if (Shape == "C") {
        ...
        cout << "Radius A: "; cin >> RadiusA;
        cout << "Radius B: "; cin >> RadiusB;
        ...
        cout << "Base A: "; cin >> BaseA;
        cout << "Base B: "; cin >> BaseB;
        ...
        cout << "Side: "; cin >> Side;
        if (Shape == "5") Area = 0.25 * (sqrt(5 * ( 5 + 2 * sqrt(5))) * pow(Side, 2));
        else if (Shape == "6") Area = (3 * sqrt(3)) * 0.5 * pow(Side, 2);
        else if (Shape == "7") Area = 3.6339124325 * pow(Side, 2);
        else if (Shape == "8") Area = 2 * (1 + sqrt(2)) * pow(Side, 2);
        else if (Shape == "9") Area = 6.18182417 * pow(Side, 2);
        else if (Shape == "10") Area = 2.5 * pow(Side, 2) * sqrt(5 + 2 * sqrt(5));
    }
